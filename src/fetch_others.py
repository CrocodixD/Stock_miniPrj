...
def fetch_others(ticker_symbol):
    ...
    base_info = f"str-it4931/stock_data/info/ticker={ticker_symbol}"
    ...
    # ── 4. FINANCIALS (annual) ────────────────────────────────────────────────────
    base_fin = f"str-it4931/stock_data/fundamentals/financials/ticker={ticker_symbol}"
    df_fin = (
        ticker.financials
              .T
              .reset_index()
    ...
    base_qfin = f"str-it4931/stock_data/fundamentals/quarterly_financials/ticker={ticker_symbol}"
    df_qfin = (
    ...
    base_apt = f"str-it4931/stock_data/fundamentals/analyst_price_targets/ticker={ticker_symbol}"
    ...
    # ── 7. INCOME STATEMENT ────────────────────────────────────────────────────────
    base_income = f"str-it4931/stock_data/fundamentals/income_statements/ticker={ticker_symbol}"
    ...
    # ── 8. EARNINGS HISTORY ───────────────────────────────────────────────────────
    base_ehist = f"str-it4931/stock_data/fundamentals/earnings_history/ticker={ticker_symbol}"
    ...
    # ── 9. EARNINGS ESTIMATE ──────────────────────────────────────────────────────
    base_eest = f"str-it4931/stock_data/fundamentals/earnings_estimates/ticker={ticker_symbol}"
